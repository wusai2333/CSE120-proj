...
public class KThread {
	...
	public void join() {
		...
		Lib.assertTrue(this != currentThread);
		Lib.assertTrue(this.tojoin == null);
		...
		if (this.status	!= statusFinished)
	 	{
			...
			this.tojoin = KThread.currentThread();
			KThread.sleep();
	...
	public static void selfTest() {
		...
		KThread thread1 = new KThread(new PingTest(1)).setName("forked thread1");
		KThread thread2 = new KThread(new PingTest(3)).setName("forked thread2");
		thread1.fork();
		thread2.fork();
		new PingTest(0).run();
